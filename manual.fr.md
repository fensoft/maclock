...
![Sélection par molette autour de Général](img/manual/touchless-focus.png)
...
| --- | --- |
| ![Accueil de la configuration](img/manual/fr/configuration-hub.png) | ![Cadran Macintosh](img/manual/clock-macintosh.png) |
...
| --- | --- |
| ![Préférences de luminosité](img/manual/fr/preferences.png) | ![Choix horloge ou émulateur](img/manual/fr/start-mode.png) |
...
![Réglage de la date et de l’heure](img/manual/fr/date-time.png)
...
| --- | --- | --- |
| ![Macintosh](img/manual/clock-macintosh.png) | ![Compact](img/manual/clock-compact.png) | ![Analogique](img/manual/clock-analog.png) |
...
![Réglages de l’économiseur](img/manual/fr/screensaver.png)

| After Dark | Champ d’étoiles | Mac rebondissant |
| --- | --- | --- |
| ![](img/manual/screensaver-after-dark.png) | ![](img/manual/screensaver-starfield.png) | ![](img/manual/screensaver-bouncing-mac.png) |

| Pluie Matrix | Tuyaux | Horloges volantes |
| --- | --- | --- |
| ![](img/manual/screensaver-matrix-rain.png) | ![](img/manual/screensaver-pipes.png) | ![](img/manual/screensaver-flying-clocks.png) |

| Grille-pain volants | Bandeau | Horloge pluie numérique |
| --- | --- | --- |
| ![](img/manual/screensaver-flying-toasters.png) | ![](img/manual/screensaver-marquee.png) | ![](img/manual/screensaver-digital-rain-clock.png) |

| Mystify | Aquarium | Jeu de la vie |
| --- | --- | --- |
| ![](img/manual/screensaver-mystify.png) | ![](img/manual/screensaver-aquarium.png) | ![](img/manual/screensaver-life.png) |

| Labyrinthe | Parade d’erreurs | Fenêtre pluvieuse |
| --- | --- | --- |
| ![](img/manual/screensaver-maze.png) | ![](img/manual/screensaver-error-parade.png) | ![](img/manual/screensaver-rainy-window.png) |

| Feux d’artifice | Diaporama photo |
| --- | --- |
| ![](img/manual/screensaver-fireworks.png) | ![](img/manual/screensaver-photo-slideshow.png) |
...
| --- | --- |
| ![](img/manual/fr/night-schedule.png) | ![](img/manual/fr/night-behavior.png) |
...
| Choix | Alarme | Heure |
| --- | --- | --- |
| ![](img/manual/alarm-timer-home.png) | ![](img/manual/alarm-selection.png) | ![](img/manual/alarm-time.png) |

| Jours | Son | Volume |
| --- | --- | --- |
| ![](img/manual/alarm-days.png) | ![](img/manual/alarm-sound.png) | ![](img/manual/alarm-volume.png) |
...
![Réglage du minuteur](img/manual/timer-editor.png)
...
| --- | --- | --- | --- |
| ![](img/manual/fr/chime-mode.png) | ![](img/manual/fr/chime-sound.png) | ![](img/manual/fr/chime-volume.png) | ![](img/manual/fr/quiet-hours.png) |
...
| --- | --- |
| ![](img/manual/fr/wifi.png) | ![](img/manual/wifi-setup-qr.png) |
...
![Lanceur du panneau web](img/manual/control-panel-launcher.png)
...
| --- | --- |
| ![](img/manual/fr/software-update-page.png) | ![](img/manual/software-update.png) |
...
| --- | --- | --- |
| ![](img/manual/fr/tools.png) | ![](img/manual/diagnostics.png) | ![](img/manual/fr/about.png) |
...
| --- | --- |
| ![](img/emulator_about.jpg) | ![](img/emulator_paint.jpg) |
