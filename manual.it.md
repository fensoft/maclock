...
![Selezione tramite manopola](img/manual/touchless-focus.png)
...
| --- | --- |
| ![](img/manual/it/configuration-hub.png) | ![](img/manual/clock-macintosh.png) |
...
| --- | --- |
| ![](img/manual/it/preferences.png) | ![](img/manual/it/start-mode.png) |
...
![Data e ora](img/manual/it/date-time.png)
...
![Impostazioni salvaschermo](img/manual/it/screensaver.png)
...
| --- | --- |
| ![](img/manual/it/night-schedule.png) | ![](img/manual/it/night-behavior.png) |
...
![Timer](img/manual/timer-editor.png)
...
| --- | --- | --- | --- |
| ![](img/manual/it/chime-mode.png) | ![](img/manual/it/chime-sound.png) | ![](img/manual/it/chime-volume.png) | ![](img/manual/it/quiet-hours.png) |
...
| --- | --- |
| ![](img/manual/it/wifi.png) | ![](img/manual/wifi-setup-qr.png) |
...
![Launcher del pannello web](img/manual/control-panel-launcher.png)
...
| --- | --- |
| ![](img/manual/it/software-update-page.png) | ![](img/manual/software-update.png) |
...
| --- | --- | --- |
| ![](img/manual/it/tools.png) | ![](img/manual/diagnostics.png) | ![](img/manual/it/about.png) |
...
![Croce di calibrazione](img/manual/touch-calibration.png)
