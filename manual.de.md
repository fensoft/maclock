...
![Auswahl mit dem Drehregler](img/manual/touchless-focus.png)
...
| --- | --- |
| ![](img/manual/de/configuration-hub.png) | ![](img/manual/clock-macintosh.png) |
...
| --- | --- |
| ![](img/manual/de/preferences.png) | ![](img/manual/de/start-mode.png) |
...
![Datum und Uhrzeit](img/manual/de/date-time.png)
...
![Bildschirmschoner-Einstellungen](img/manual/de/screensaver.png)
...
| Zeitplan | Verhalten |
| --- | --- |
| ![](img/manual/de/night-schedule.png) | ![](img/manual/de/night-behavior.png) |
...
| --- | --- | --- | --- |
| ![](img/manual/de/chime-mode.png) | ![](img/manual/de/chime-sound.png) | ![](img/manual/de/chime-volume.png) | ![](img/manual/de/quiet-hours.png) |
...
| --- | --- |
| ![](img/manual/de/wifi.png) | ![](img/manual/wifi-setup-qr.png) |
...
![Web-Bedienfeld](img/manual/control-panel-launcher.png)
...
| --- | --- |
| ![](img/manual/de/software-update-page.png) | ![](img/manual/software-update.png) |
...
| --- | --- | --- |
| ![](img/manual/de/tools.png) | ![](img/manual/diagnostics.png) | ![](img/manual/de/about.png) |
...
![Kalibrierungskreuz](img/manual/touch-calibration.png)
