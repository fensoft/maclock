...
![Selección mediante el control giratorio](img/manual/touchless-focus.png)
...
| --- | --- |
| ![Centro de configuración](img/manual/es/configuration-hub.png) | ![Esfera Macintosh](img/manual/clock-macintosh.png) |
...
| --- | --- |
| ![](img/manual/es/preferences.png) | ![](img/manual/es/start-mode.png) |
...
![Editor de fecha y hora](img/manual/es/date-time.png)
...
| --- | --- | --- |
| ![](img/manual/clock-macintosh.png) | ![](img/manual/clock-compact.png) | ![](img/manual/clock-analog.png) |
...
![Ajustes del salvapantallas](img/manual/es/screensaver.png)
...
| --- | --- |
| ![](img/manual/es/night-schedule.png) | ![](img/manual/es/night-behavior.png) |
...
![Editor del temporizador](img/manual/timer-editor.png)
...
| --- | --- | --- | --- |
| ![](img/manual/es/chime-mode.png) | ![](img/manual/es/chime-sound.png) | ![](img/manual/es/chime-volume.png) | ![](img/manual/es/quiet-hours.png) |
...
| --- | --- |
| ![](img/manual/es/wifi.png) | ![](img/manual/wifi-setup-qr.png) |
...
![Lanzador del panel web](img/manual/control-panel-launcher.png)
...
| --- | --- |
| ![](img/manual/es/software-update-page.png) | ![](img/manual/software-update.png) |
...
| --- | --- | --- |
| ![](img/manual/es/tools.png) | ![](img/manual/diagnostics.png) | ![](img/manual/es/about.png) |
