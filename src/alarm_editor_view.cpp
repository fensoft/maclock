...
#if 0 // Moved to alarm_storage.cpp and alarm_ui_internal.h.
...
static void UpdateLanguageMaps()
{
    g_slot_map[0] = tr("Alarm 1"); g_slot_map[1] = tr("Alarm 2");
    g_slot_map[2] = tr("Alarm 3"); g_slot_map[3] = "";
    g_enabled_map[0] = tr("Disabled"); g_enabled_map[1] = tr("Enabled"); g_enabled_map[2] = "";
    g_time_map[0] = tr("Hour -"); g_time_map[1] = tr("Hour +"); g_time_map[2] = tr("Minute -"); g_time_map[3] = tr("Minute +"); g_time_map[4] = "";
    g_days_map[0] = tr("Mon"); g_days_map[1] = tr("Tue"); g_days_map[2] = tr("Wed"); g_days_map[3] = tr("Thu"); g_days_map[4] = "\n"; g_days_map[5] = tr("Fri"); g_days_map[6] = tr("Sat"); g_days_map[7] = tr("Sun"); g_days_map[8] = "";
    g_page_names[0] = tr("Alarm / Timer"); g_page_names[1] = tr("Alarm"); g_page_names[2] = tr("Time"); g_page_names[3] = tr("Days"); g_page_names[4] = tr("Options"); g_page_names[5] = tr("Label"); g_page_names[6] = tr("Sound"); g_page_names[7] = tr("Volume"); g_page_names[8] = tr("Actions");
    g_options_map[0] = tr("One time"); g_options_map[1] = tr("Gradual volume"); g_options_map[2] = "\n"; g_options_map[3] = tr("Sunrise screen"); g_options_map[4] = tr("Repeat"); g_options_map[5] = "";
    g_label_map[0] = tr("Alarm"); g_label_map[1] = tr("Wake up"); g_label_map[2] = "\n"; g_label_map[3] = tr("Work"); g_label_map[4] = tr("Medicine"); g_label_map[5] = tr("None"); g_label_map[6] = "";
}
...
#if 0 // Moved to alarm_ringing_view.cpp.
...
#if 0 // Moved to alarm_service.cpp.
...
void AlarmView::showRinging(size_t alarm_index)
{
    alarm_ringing_show(alarm_index);
}

void AlarmView::updateRinging(size_t alarm_index, uint32_t elapsed_ms)
{
    alarm_ringing_update(alarm_index, elapsed_ms);
}
...
void AlarmView::refreshLanguage()
{
    ...
    alarm_ringing_refresh_language();
