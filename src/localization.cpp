...
static const Translation g_translations[] = {
    ...
    {"Refresh Assets", "Actualiser ressources", "Actualizar recursos", "Assets aktualisieren", "Aggiorna risorse"},
    {"Refreshing assets...", "Actualisation des ressources...", "Actualizando recursos...", "Assets werden aktualisiert...", "Aggiornamento risorse..."},
    {"Assets refreshed.", "Ressources actualisées.", "Recursos actualizados.", "Assets aktualisiert.", "Risorse aggiornate."},
    {"Reboot to load them.", "Redémarrez pour les charger.", "Reinicie para cargarlos.", "Zum Laden neu starten.", "Riavvia per caricarle."},
    {"Asset refresh failed.", "Échec de l'actualisation.", "Error al actualizar recursos.", "Asset-Aktualisierung fehlgeschlagen.", "Aggiornamento risorse non riuscito."},
    ...
    {"Show seconds: %s", "Afficher secondes : %s", "Mostrar segundos: %s", "Sekunden anzeigen: %s", "Mostra secondi: %s"},
    ...
    {"Face Settings", "Réglages du cadran", "Ajustes de esfera", "Zifferblatt-Einstellungen", "Impostazioni quadrante"},
    {"Animation: %s", "Animation : %s", "Animación: %s", "Animation: %s", "Animazione: %s"},
    {"Blink: %s", "Clignotement : %s", "Parpadeo: %s", "Blinken: %s", "Lampeggio: %s"},
    {"Continuous: %s", "Continu : %s", "Continuo: %s", "Fortlaufend: %s", "Continuo: %s"},
    {"Animation: Normal", "Animation : Normale", "Animación: Normal", "Animation: Normal", "Animazione: Normale"},
    {"Blink: Yes", "Clignotement : Oui", "Parpadeo: Sí", "Blinken: Ja", "Lampeggio: Sì"},
    {"Continuous: No", "Continu : Non", "Continuo: No", "Fortlaufend: Nein", "Continuo: No"},
    {"Show seconds: No", "Afficher secondes : Non", "Mostrar segundos: No", "Sekunden anzeigen: Nein", "Mostra secondi: No"},
    ...
    {"Flying Toasters", "Grille-pain volants", "Tostadoras voladoras", "Fliegende Toaster", "Tostapane volanti"},
    {"Marquee Message", "Message défilant", "Mensaje deslizante", "Laufschrift", "Messaggio scorrevole"},
    {"Digital Rain Clock", "Horloge pluie numérique", "Reloj de lluvia digital", "Digitalregen-Uhr", "Orologio pioggia digitale"},
    {"Mystify", "Mystify", "Mystify", "Mystify", "Mystify"},
    {"Aquarium", "Aquarium", "Acuario", "Aquarium", "Acquario"},
    {"Game of Life", "Jeu de la vie", "Juego de la vida", "Spiel des Lebens", "Gioco della vita"},
    {"Maze", "Labyrinthe", "Laberinto", "Labyrinth", "Labirinto"},
    {"Error Parade", "Parade d’erreurs", "Desfile de errores", "Fehlerparade", "Parata degli errori"},
    {"Rainy Window", "Fenêtre pluvieuse", "Ventana lluviosa", "Regenfenster", "Finestra piovosa"},
    {"Fireworks", "Feux d’artifice", "Fuegos artificiales", "Feuerwerk", "Fuochi d’artificio"},
    {"Photo Slideshow", "Diaporama photo", "Presentación de fotos", "Foto-Diashow", "Presentazione foto"},
    ...
    {"Touchscreen required", "Écran tactile requis", "Pantalla táctil requerida", "Touchscreen erforderlich", "Touchscreen richiesto"},
    {"Touchscreen", "Écran tactile", "Pantalla táctil", "Touchscreen", "Touchscreen"},
    {"Present", "Présent", "Presente", "Vorhanden", "Presente"},
    {"Missing", "Absent", "Ausente", "Fehlt", "Assente"},
    ...
    {"Unnamed face", "Cadran sans nom", "Esfera sin nombre", "Unbenanntes Zifferblatt", "Quadrante senza nome"},
    {"Clock Face Error\n%s", "Erreur de cadran\n%s", "Error de esfera\n%s", "Zifferblattfehler\n%s", "Errore quadrante\n%s"},
    {"Project missing", "Projet introuvable", "Proyecto no encontrado", "Projekt fehlt", "Progetto mancante"},
    {"Invalid project", "Projet invalide", "Proyecto no válido", "Ungültiges Projekt", "Progetto non valido"},
    {"Unsupported layer", "Calque non pris en charge", "Capa no compatible", "Ebene nicht unterstützt", "Livello non supportato"},
    {"Error", "ERREUR", "ERROR", "FEHLER", "ERRORE"},
    {"Add JPG", "AJOUT JPG", "PON JPG", "JPG HINZU", "AGG JPG"},
    {"Weather", "Météo", "Tiempo", "Wetter", "Meteo"},
    {"Sunny", "Ensoleillé", "Soleado", "Sonnig", "Soleggiato"},
    {"Cloudy", "Nuageux", "Nublado", "Bewölkt", "Nuvoloso"},
    {"Rainy", "Pluvieux", "Lluvioso", "Regnerisch", "Piovoso"},
