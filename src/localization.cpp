...
static const Translation g_translations[] = {
    ...
    {"Update", "Installer", "Actualizar", "Aktualisieren", "Aggiorna"},
    {"Check Now", "Vérifier", "Comprobar", "Prüfen", "Controlla"},
    {"Reboot", "Redémarrer", "Reiniciar", "Neustart", "Riavvia"},
    {"Current version: %s", "Version actuelle : %s", "Versión actual: %s", "Aktuelle Version: %s", "Versione attuale: %s"},
    {"Latest version: %s", "Dernière version : %s", "Última versión: %s", "Neueste Version: %s", "Ultima versione: %s"},
    {"Checking for updates...", "Recherche de mises à jour...", "Buscando actualizaciones...", "Suche nach Updates...", "Ricerca aggiornamenti..."},
    {"Maclock is up to date.", "Maclock est à jour.", "Maclock está actualizado.", "Maclock ist aktuell.", "Maclock è aggiornato."},
    {"Installing update...", "Installation...", "Instalando...", "Installation...", "Installazione..."},
    {"Update is ready.", "Mise à jour prête.", "Actualización lista.", "Update ist bereit.", "Aggiornamento pronto."},
    {"Update failed.", "Échec de la mise à jour.", "Error de actualización.", "Update fehlgeschlagen.", "Aggiornamento non riuscito."},
    {"Update unavailable.", "Mise à jour indisponible.", "Actualización no disponible.", "Update nicht verfügbar.", "Aggiornamento non disponibile."},
    ...
    {"Numeral size", "Chiffres", "Números", "Ziffern", "Cifre"},
    {"Show weather", "Afficher météo", "Mostrar tiempo", "Wetter anzeigen", "Mostra meteo"},
    {"Flip speed", "Vitesse volet", "Velocidad flip", "Klappgeschw.", "Velocità palette"},
    {"Default", "Défaut", "Predeterminado", "Standard", "Predefinito"},
    {"Red", "Rouge", "Rojo", "Rot", "Rosso"},
    {"Orange", "Orange", "Naranja", "Orange", "Arancione"},
    {"Green", "Vert", "Verde", "Grün", "Verde"},
    {"Blue", "Bleu", "Azul", "Blau", "Blu"},
    {"Purple", "Violet", "Morado", "Violett", "Viola"},
    {"Small", "Petit", "Pequeño", "Klein", "Piccolo"},
    {"Large", "Grand", "Grande", "Groß", "Grande"},
    {"Slow", "Lent", "Lento", "Langsam", "Lento"},
    {"Normal", "Normal", "Normal", "Normal", "Normale"},
    {"Fast", "Rapide", "Rápido", "Schnell", "Veloce"},
    ...
    {"Stars", "Étoiles", "Estrellas", "Sterne", "Stelle"},
    {"Mac Logo", "Logo Mac", "Logo Mac", "Mac-Logo", "Logo Mac"},
    {"Matrix", "Matrix", "Matrix", "Matrix", "Matrix"},
    {"Pipes", "Tuyaux", "Tuberías", "Rohre", "Tubi"},
    {"Clocks", "Horloges", "Relojes", "Uhren", "Orologi"},
    {"Random", "Aléatoire", "Aleatorio", "Zufällig", "Casuale"},
    ...
    {"Downloading Macintosh ROM...", "Téléchargement de la\nROM...", "Descargando ROM de\nMacintosh...", "Macintosh-ROM\nwird geladen...", "Download ROM\nMacintosh..."},
    {"Downloading System 7 disk...", "Téléchargement du disque\nSystème 7...", "Descargando disco de\nSystem 7...", "System-7-Disk\nwird geladen...", "Download disco\nSystem 7..."},
    {"Installing System 7 disk...", "Installation du disque\nSystème 7...", "Instalando disco de\nSystem 7...", "System-7-Disk\nwird installiert...", "Installazione disco\nSystem 7..."},
    ...
    {"Click again for calibration", "Cliquez encore pour calibrer", "Pulse de nuevo para calibrar", "Für Kalibrierung erneut drücken", "Premi di nuovo per calibrare"},
    ...
    {"Country code", "Code pays", "Código de país", "Ländercode", "Codice paese"},
    {"Country code must contain two letters.", "Le code pays doit contenir deux lettres.", "El código de país debe tener dos letras.", "Der Ländercode muss aus zwei Buchstaben bestehen.", "Il codice paese deve contenere due lettere."},
    ...
    {"Label", "Libellé", "Etiqueta", "Bezeichnung", "Etichetta"},
    {"Schedule", "Programmation", "Programación", "Zeitplan", "Programmazione"},
    {"Repeat", "Répéter", "Repetir", "Wiederholen", "Ripeti"},
    {"Gradual volume", "Volume progressif", "Volumen gradual", "Lautstärke steigern", "Volume graduale"},
    {"Gradual", "Progressif", "Gradual", "Steigend", "Graduale"},
    {"Sunrise screen", "Écran lever du soleil", "Pantalla amanecer", "Sonnenaufgang-Anzeige", "Schermo alba"},
    {"Sunrise", "Aube", "Amanecer", "Sonnenaufgang", "Alba"},
    {"Wake up", "Réveil", "Despertar", "Aufwachen", "Sveglia"},
    {"Work", "Travail", "Trabajo", "Arbeit", "Lavoro"},
    {"Medicine", "Médicament", "Medicación", "Medikament", "Medicinale"},
    {"No label", "Sans libellé", "Sin etiqueta", "Keine Bezeichnung", "Senza etichetta"},
    {"No upcoming alarm", "Aucune alarme à venir", "No hay próximas alarmas", "Kein kommender Alarm", "Nessuna sveglia in arrivo"},
    {"Next alarm", "Prochaine alarme", "Próxima alarma", "Nächster Alarm", "Prossima sveglia"},
    {"Tomorrow", "Demain", "Mañana", "Morgen", "Domani"},
    {"Hour -", "Heure -", "Hora -", "Stunde -", "Ora -"},
    {"Hour +", "Heure +", "Hora +", "Stunde +", "Ora +"},
    {"Minute -", "Minute -", "Minuto -", "Minute -", "Minuto -"},
    {"Minute +", "Minute +", "Minuto +", "Minute +", "Minuto +"},
